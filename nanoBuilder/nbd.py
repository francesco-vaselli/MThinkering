...
if __name__=='__main__':
	...
	muon_cond = ["MGenMuon_eta", "MGenMuon_phi", "MGenMuon_pt", "MGenPart_statusFlags1", "MGenPart_statusFlags3", "MGenPart_statusFlags4",
			"MGenPart_statusFlags5", "MGenPart_statusFlags6", "MGenPart_statusFlags7", "MGenPart_statusFlags8", "MGenPart_statusFlags9", "MGenPart_statusFlags10", "MGenPart_statusFlags11", "MGenPart_statusFlags13", "MClosestJet_dr", "MClosestJet_deta", "MClosestJet_dphi", "MClosestJet_pt", "MClosestJet_mass","Pileup_gpudensity", "Pileup_nPU", "Pileup_nTrueInt", "Pileup_pudensity", "Pileup_sumEOOT", "Pileup_sumLOOT", "MGenMuon_charge"]
	...
	dfel = tree.arrays(['Electron_mvaFall17V2Iso_WP90', 'Electron_eta', 'Electron_pt'], library="pd").astype('float32').dropna()
	print(dfel)
	...
	muon_names = ["etaMinusGen", "phiMinusGen", "ptRatio", "dxy", "dxyErr",  "dz", "dzErr", "ip3d", "isGlobal", "isPFcand","isTracker", "jetPtRelv2","jetRelIso", "mediumId", "pfRelIso03_all", "pfRelIso03_chg", "pfRelIso04_all", "ptErr","sip3d", "softId", "softMva", "softMvaId"]
	...
	jet_names = ["area", "btagCMVA", "btagCSVV2", "btagDeepB", "btagDeepC", "btagDeepFlavB", "btagDeepFlavC",
        	"eta", "bRegCorr", "mass", "nConstituents", "phi", "pt", "puIdDisc", "qgl",
        	"muEF", "nMuons"]
	to_ttreej = dict(zip(jet_names, totalj.T))
	to_ttreej = ak.unflatten(ak.Array(to_ttreej), events_structure_jets)

	muon_names = ["eta", "phi", "pt", "dxy", "dxyErr",  "dz", "dzErr", "ip3d", "isGlobal", "isPFcand","isTracker", "jetPtRelv2","jetRelIso", "mediumId", "pfRelIso03_all", "pfRelIso03_chg", "pfRelIso04_all", "ptErr","sip3d", "softId", "softMva", "softMvaId", "charge"]

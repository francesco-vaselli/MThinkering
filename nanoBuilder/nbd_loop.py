...
if __name__=='__main__':
    ...
    new_root = '/gpfs/ddn/cms/user/fvaselli/TTJets/'
    ...
    files_paths = [os.path.join(d, f) for d in os.listdir(root) for f in os.listdir(os.path.join(root, d))] # = [x for x in pathlib.Path(root).glob('**/*')]

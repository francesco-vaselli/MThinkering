# events generation through normalizing spline flows. best performance for 8 bins, bs 1024, hd 512, nb 10, nf 15, lr = 5e-6 import matplotlib.pyplot as plt
import numpy as np
...
class H5Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        y = self.archives[file_idx]["data"][idx_in_file, 0:14]
        x = self.archives[file_idx]["data"][idx_in_file, 14:31]

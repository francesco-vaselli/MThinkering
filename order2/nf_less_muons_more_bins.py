...
class H5Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        y = self.archives[file_idx]["data"][idx_in_file, 0:20]
        x = self.archives[file_idx]["data"][idx_in_file, 20:36]
...
def save_model(epoch, model, scheduler, train_history, test_history, model_dir=None):
    ...
    filename=f'model_less_muons_more_bins_@epoch_{epoch}.pt'
...
if __name__=='__main__':
    ...
    param_dict = { "num_transform_blocks": 5,
                "activation" : "elu",
                "num_bins" : 128,
                "hidden_dim" : 256

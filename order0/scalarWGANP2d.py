...
if __name__ == '__main__':
    ...
    b1 = (1 - beta.rvs(a=17, b=1, size=1500))
    b2 = (beta.rvs(a=17, b=1, size=1500))
    ...
    for epoch in range(num_epochs):
        ...
        for i, data in progress_bar:
            ...
            errD = -errD_real + errD_fake + gradient_penalty * 0.05
            errD.backward()
            # Update D
            optimizerD.step()
    ...
    # test statistics
    test_output = netG(test_noise).cpu().detach().numpy()
